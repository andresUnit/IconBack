# -*- coding: utf-8 -*-
"""
Created on Fri Jan 15 10:18:07 2021
...
tipos = ['n_rebose_canaleta_7','corriente_rastras_7']

def Data_base(df,tipo):
    df.fillna(df.mean(), inplace=True)
    data =  [f'{tipo}','descarga_solido_7', 'n_agua_clara_7', 'torque_rastras_7','alimentacion_pulpa_7','descarga_pulpa_7','floculante_7','porcSolido_cajon']
    df_aux = df[data]
    return df_aux
...
model.save("D:\GIT\ICON\Modelos\descarga_rebose.h5")

model = load_model("D:\GIT\ICON\Modelos\descarga_rebose.h5")
