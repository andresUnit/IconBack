# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 16:35:39 2021
...
def print_data(vector):
    print("Nivel de Agua Clara: ", vector[0][0])
...
tipos = ['descarga_solido_7', 'n_agua_clara_7', 'torque_rastras_7']
#tipos = ['descarga_solido_7', 'n_agua_clara_7', 'torque_rastras_7','alimentacion_pulpa_7','descarga_pulpa_7','floculante_7','porcSolido_cajon']
data = df[tipos]

data = Data_base(df,tipos[1])
...
model.save("D:\GIT\ICON\Modelos\ N_clara.h5")

model = load_model("D:\GIT\ICON\Modelos\ N_clara.h5")
...
def simulacion(state, model = model, change = False ):
    if change:
        ...
        print("Flujo Masico: ")
        print(flujoM)
        print("Variacion de Nivel de Agua Clara: ")
        print(variacion[0][0])
        return state_aux
